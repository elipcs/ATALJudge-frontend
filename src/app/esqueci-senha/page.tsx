        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl border border-white/20 p-4 sm:p-6 md:p-8">
          ...
          {message && (
            <div className="mb-4 sm:mb-6 bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4">
              <div className="flex items-center">
                ...
                <span className="text-green-700 text-xs sm:text-sm font-medium">{message}</span>
              </div>
            </div>
          )}
          ...
          <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-slate-50 rounded-lg border border-slate-200">
            <div className="flex items-start">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-slate-500 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <div className="text-xs sm:text-sm text-slate-600">
                <p className="font-medium mb-1">Como funciona:</p>
                <p>Você receberá um e-mail com um link seguro para redefinir sua senha. O link será válido por 1 hora.</p>
              </div>
            </div>
          </div>
