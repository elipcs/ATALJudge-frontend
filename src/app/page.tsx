      ...
      <div className="w-full max-w-lg mx-auto">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8 sm:p-12 text-center">
          ...
          <div className="mb-4 sm:mb-6 flex justify-center">
            ...
            >
                <g transform="translate(0.000000,375.000000) scale(0.100000,-0.100000)" fill="slate-900" stroke="none">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 mb-4">
                Bem-vindo ao<br />ATAL JUDGE
              </h1>
              
              <p className="text-slate-600 text-lg sm:text-xl leading-relaxed max-w-md mx-auto">
            ...
            <Link href="/login" className="w-full block">
              <Button size="lg" className="w-full bg-gradient-to-r from-slate-800 to-slate-900 hover:from-slate-900 hover:to-slate-950 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02]">
