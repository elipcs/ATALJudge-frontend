  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-100 via-white to-indigo-200">
      <div className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-xl p-8 sm:p-10 flex flex-col items-center">
        <div className="mb-6 flex justify-center" style={{ color: 'var(--color-primary)' }}>
          <svg width="220" height="80" viewBox="0 0 666 375" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block' }} aria-label="Logo ATAL JUDGE">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold mb-8 text-center" style={{ color: 'var(--color-primary)' }}>
          Bem-vindo ao<br />
          <span>ATAL JUDGE</span>
        </h1>
        <p className="text-gray-600 mb-8 text-center text-base sm:text-xl">Uma plataforma dedicada ao aprendizado e avaliação de algoritmos.</p>
        <Link href="/login" className="w-full">
          <Button className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-2 text-lg rounded-md">
            Entrar
          </Button>
        </Link>
      </div>
