  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-100 via-white to-indigo-200">
      <div className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-xl p-8 sm:p-10 flex flex-col items-center">
        ...
        <h1 className="text-3xl font-extrabold text-gray-900 mb-2 text-center">Redefinir senha</h1>
        <p className="text-gray-600 mb-6 text-center">Digite e confirme sua nova senha para acessar a plataforma</p>
        {success ? (
          <div className="w-full text-center">
            <p className="text-green-600 font-semibold mb-6">Senha redefinida com sucesso!</p>
            <Link href="/login">
              <Button className="w-full bg-indigo-500 hover:bg-indigo-600 text-white font-semibold py-2 text-lg rounded-md mt-2">
                Ir para o login
              </Button>
            </Link>
          </div>
          ...
          <form className="w-full flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            {error && <div className="text-red-500 text-sm text-center">{error}</div>}
              <Button
                type="submit"
                className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-2 text-lg rounded-md mt-2"
              >
                Redefinir senha
              </Button>
          </form>
