...
export default function ForgotPasswordPage() {
  ...
  <span className="mb-2" style={{ width: 180, height: 60, display: 'inline-block' }}>
        ...
        <h1 className="text-3xl font-extrabold text-gray-900 mb-2 text-center">Recuperar senha</h1>
        <p className="text-gray-600 mb-6 text-center">Informe seu e-mail para receber o link de redefinição</p>
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
          ...
          <Button type="submit" className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-2 text-lg rounded-md mt-2">Enviar</Button>
        </form>
        <div className="w-full flex justify-between mt-4 text-sm">
          <button type="button" className="text-indigo-600 hover:underline" onClick={() => router.push("/login")}>Voltar ao login</button>
