        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl border border-white/20 p-4 sm:p-6 md:p-8">
          ...
          <div className="mb-4 sm:mb-6 flex justify-center">
            <svg 
              ...
              viewBox="0 0 666 375" 
              fill="currentColor" 
              className="text-slate-900 w-24 h-9 sm:w-32 sm:h-12 md:w-40 md:h-15"
          ...
          {/* Divider */}
          {/* Footer Links */}
          <div className="flex flex-col sm:flex-row justify-between items-center mt-4 sm:mt-6 gap-3 sm:gap-4 text-sm">
            <button
              type="button"
