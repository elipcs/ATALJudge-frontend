            ...
            {links.map((link) => {
              ...
              return (
                <div key={link.href}>
                  <Link
                    href={link.href}
                    className={`flex ${isCollapsed ? 'justify-center items-center' : 'items-center gap-3'} text-sm font-medium rounded-xl transition-all duration-300 ease-in-out relative group ${
                      isActive
